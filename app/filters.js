  ...
  render() {
    return(
      <div className="controls">
        <h3>Filters:</h3>
        <label>Use WebGl<input type="checkbox" id="webgl" /></label>
        <p>
        ...
        <p>
          <label><span>Sepia:</span> <input type="checkbox" name="sepia" id="sepia" checked={this.state.sepia} onChange={this.handleInputChange}/></label>
        </p>
        <p>
